(() => {
    ...
    function initSliders() {
        if (document.querySelector(".catalog-page")) new core(".catalog-page__slider", {
        ...
        if (document.querySelector(".item-design__slider")) new core(".item-design__slider", {
            modules: [ Navigation ],
            slidesPerView: 1,
            spaceBetween: 20,
            speed: 800,
            loop: true,
            navigation: {
                nextEl: " .controls-design__arrow_next",
                prevEl: " .controls-design__arrow_prev"
            }
        });
        if (document.querySelector(".reviews-page")) new core(".reviews-page__slider", {
            modules: [ Navigation ],
            slidesPerView: 1,
            spaceBetween: 40,
            speed: 800,
            loop: true,
            navigation: {
                nextEl: " .controls-reviews__arrow_next",
                prevEl: " .controls-reviews__arrow_prev"
            }
        });
    }
